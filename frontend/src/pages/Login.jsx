...
export default function Login() {
  ...
  return (
    <div className="max-w-sm mx-auto space-y-8">
      <h1 className="font-display text-4xl font-semibold leading-[0.92]">{mode === 'login' ? 'entrar' : 'criar conta'}</h1>
      ...
      <button className="btn w-full" onClick={submit}>{mode === 'login' ? 'entrar' : 'criar conta gratis'}</button>
